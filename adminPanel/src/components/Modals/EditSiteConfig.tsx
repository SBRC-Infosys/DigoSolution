...
const EditModal = ({  item,
  ...
  const [imgUrls, setImgUrls] = useState<string[]>([item.logo_url]);

  const [companyName,setCompanyName] = useState<string>(item.company_name);
  ...
  const handleUpdate = async () => {
    ...
    try {
      ...
      toast.error('Failed to update in the company.Try Again!')
