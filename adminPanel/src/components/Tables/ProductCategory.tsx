...
const ProductCategory = () => {
  const [item, setItem] = useState<ProductCategory>();
  ...
  const { data, error, isLoading, refetch } = useQuery<ProductCategory[]>({
  ...
  const handleModalBox = (categoryItem: ProductCategory) => {
