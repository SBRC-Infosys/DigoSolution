      ...
      <div className="container ">
        <ol className="list-decimal  grid grid-cols-2 ">
          <li className="mb-4 p-4">
            ...
            <li >
              Personal Information: This may include your name, em ail address,
              phone number, and any other personal details you provide to us.
            </li>
            <li >
            ...
            <li >
              ...
              technologies to collect information and improve your experience on
              our website.
            </li>
            </ol>
          </li>
          <li className="mb-4 p-4">
            <h1 className="text-xl font-semibold"> How We Use Your Information</h1>
            <p className="font-bold">
        ...
        functionality. To send you updates, promotional materials, or other
        communications that may be of interest to you (you may opt out at any
        time).
            </li>
          ...
          <li className="mb-4 p-4">
            ...
            <p className="font-bold">
            We will not share, sell, or rent your personal information to third parties except in the following cases:
            </p>
            <ol className="list-disc pt-4 pl-4">
            <li >
        ...
        and delivering services to you.
            ...
            <li >
            For Legal Reasons: We may disclose your
        information if required to do so by law or to protect the rights,
        property, or safety of Diago Solutions, our users, or others
            </li>
            </ol>
          </li>
          <li className="mb-4 p-4">
        ...
        have the right to:
            ...
            <li >
            Correction: Request that we correct any inaccuracies in
        your personal information. 
            </li>
            <li >
            FDeletion: Request that we delete your
